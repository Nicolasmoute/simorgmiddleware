...
```mermaid
flowchart LR
    subgraph US["🇺🇸 United States 2024"]
        US_SAV["Domestic saving<br/>$4.83 T"]
        US_FOR["Foreign capital IN<br/>+$1.18 T"]
        US_GOV["Govt debt<br/>+$1.90 T<br/>(dom. $1.22T / for. $0.68T)"]
        US_INV["Economic investment<br/>$6.31 T"]
        US_SAV -->|~$1.22T| US_GOV
        US_SAV -->|~$3.61T| US_INV
        US_FOR -->|~$0.68T| US_GOV
        US_FOR -->|~$0.50T| US_INV
    end
    subgraph EU["🇪🇺 Euro area 2024"]
        EU_SAV["Domestic saving<br/>$4.02 T (€3.72T)"]
        EU_GOV["Govt debt<br/>+$0.56 T (€513B)"]
        EU_INV["Economic investment<br/>$3.56 T (€3.29T)"]
        EU_OUT["Capital OUT to world<br/>−$0.45 T (€419B)"]
        EU_SAV -->|~€395B| EU_GOV
        EU_SAV -->|~€3.32T| EU_INV
        EU_SAV -->|surplus €431B| EU_OUT
    end
```
